...
matches the project slug (`opentrattos`, `eligia`, `palafito`, …) — see
...
Auth resolution
---------------
The client tries CF Access service auth first (current ELIGIA deployment),
...
class HindsightCreds:
    ...
    def headers(self) -> dict[str, str]:
        ...
        # upstream API), the caller can extend this dict — for now ELIGIA's
