"""Query the eligia-skills HTTP registry for the catalog of available skills.
...
def _cmd_list(args: argparse.Namespace) -> int:
    ...
    if not url:
        ...
        emit_error(
            ...
            fix="export SKILLS_REGISTRY_URL=https://eligia-skills.palafitofood.com "
...
def _build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        ...
        description="Query the eligia-skills HTTP registry (T20).",
    )
