...
See `docs/concepts/projects-registry.md` for the registry format and resolution rules.
...
def write_registry(path: Path, data: dict) -> None:
    ...
    with path.open("w", encoding="utf-8") as f:
        f.write(
            ...
            "# See docs/concepts/projects-registry.md in ai-playbook.\n"
        )
...
if __name__ == "__main__":
    ...
    raise SystemExit(script_emit("discover-projects", main))
