...
- Replace `<project-bank>` with the project's bank id from [`../specs/memory-hierarchy.md`](../specs/memory-hierarchy.md) §2 (e.g. `consumer-c-legacy`, `consumer-d`, `consumer-b`).
