...
8. **Determine notification obligations.**
   ...
   For consumer-d (solo-state, no paying customers as of 2026-05-01): no regulatory obligation today; obligation flips on with the same trigger as `incident-response.md` §2 (first paying SaaS customer).
