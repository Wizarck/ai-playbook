...
4. **Add an entry to this inventory.** Append a new row to §2 with the correct prefix
   (`eligia/...` or `palafito/...`) and a one-line Purpose.
...
- `eligia-core/langgraph-aiops/workflows/upstream_refresher.py` — weekly refresh workflow.
