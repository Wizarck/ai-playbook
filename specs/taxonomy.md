...
|---|---|---|---|
| Agent | An LLM-driven entity with a system prompt, a tool set, a session context, and a goal. | Claude Sonnet instance running via Claude Code CLI in `C:\Projects\nexandro`. | runtime |
