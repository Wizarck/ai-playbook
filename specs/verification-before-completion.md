...
apps/api/src/consumer-e/contexts/<slice>/` and reports clean has **not
...
This rule was retro-proven by consumer-e Wave 2 slice P1
(`approval-channels-multichannel`, 2026-05-06): six `mypy --strict` errors
in test files were invisible at `apps/api/src/consumer-e/contexts/approval/`
