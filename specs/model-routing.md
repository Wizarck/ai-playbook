...
Provider-specific rate limits, pricing snapshots, cache-prefix strategy per provider, and the linkage to `lib/advisor.py` (eligia-core) that does multi-provider review.
