...
- **LiteLLM at ELIGIA port `4000`** uniformly exposes OpenAI-compatible responses. Cache-hit signals from upstream are passed through when present; absence of the field does not mean absence of caching, just absence of reporting.
