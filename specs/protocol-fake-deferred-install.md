...
```python
# apps/api/src/iguanatrader/contexts/research/synthesis/llm_client.py
...
```python
# apps/api/src/iguanatrader/contexts/research/synthesis/anthropic_client.py
from anthropic import AsyncAnthropic
from iguanatrader.observability.cost_meter import cost_meter
...
|---|---|---|---|---|
| iguanatrader | research-brief-synthesis | `LLMClient` | `FakeLLMClient` | `AnthropicLLMClient` (deployment-foundation) |
