...
This rule was retro-proven on nexandro PR #89 (`m2-wrap-up`,
...
Failure mode this prevents: surfaced 2026-05-06 in iguanatrader Wave 2 — PR #68 (R1) and PR #69 (T1) merged on 2026-05-05 but the OpenSpec changes sat in the active tree for 28 hours; required a manual closeout PR (#78). Operator burden compounds across waves.
...
| `nexandro` | PUBLIC | A | full migration | OSS BOH project; description already reads "Open Source". |
