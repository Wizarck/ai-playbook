...
### Followup 1 — `propagate_bump.py` doesn't bump `AGENTS.md` `inherits_from:`
...
### Followup 2 — Supersede uses tag-push chronology, not semver order
...
### Followup 3 — `block_manual_spec_edit.py::read_commit_message` doesn't read CI env vars
