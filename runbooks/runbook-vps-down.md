...
>
> Stub means: the steps below capture the canonical recovery sequence, but specific commands assume the canonical consumer (eligia-core) topology. Per-consumer richer runbooks (e.g. `eligia-core/runbooks/runbook-vps-disaster-recovery.md`) link from here.
