...
2. Validate against ONE consumer (typically iguanatrader): merge bumps,
...
```bash
for repo in Wizarck/nexandro Wizarck/eligia-core Wizarck/iguanatrader Wizarck/palafito-b2b Wizarck/livekit; do
  echo "=== $repo ==="
...
1. Pick the canonical first-run consumer (default: `iguanatrader`).
...
│ 3. Validate against ONE consumer (iguanatrader by default)  │
...
for repo in Wizarck/nexandro Wizarck/eligia-core; do
