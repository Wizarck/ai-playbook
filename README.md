...
Universal AI-dev norms, specs, scripts, and templates consumed via **git submodule** by every project under Arturo / Wizarck org (consumer-c-legacy, consumer-d, consumer-b, future projects).
