...
"""
    ...
    assert "- Wizarck/eligia-skills@v0.3.0" in out, "non-target source must not be touched"
...
schema: agents-md/v1
inherits_from:
  - github.com/Wizarck/eligia-skills@v0.3.0
---
"""
    p = _agents_md(src, tmp_path)
    changed, detail = _bumper.bump_agents_md_pin(p, "ai-playbook", "v0.9.1")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("chore/bump-skills-eligia-skills-v0.3.0-rc1", True),
