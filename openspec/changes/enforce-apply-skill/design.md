...
// start record
{
  ...
  "user": "arturo6ramirez@gmail.com",  // from git config or env
...
```jsonc
{
  "tool_name": "Edit",
  "tool_input": {
    "file_path": "C:\\Projects\\geeplo\\backend\\app\\blueprints\\revalid\\service_bulk.py",
    "old_string": "...",
    "new_string": "..."
  },
  "cwd": "C:\\Projects\\geeplo",
  "session_id": "claude-9f4b..."
}
```
...
| Adopting in `geeplo` | — | Follow-up PR in geeplo (this slice ships the template; geeplo copies it) |
| Adopting in `eligia-core` / `palafito-b2b` / `openTrattOS` | — | Follow-up PR per consumer |
