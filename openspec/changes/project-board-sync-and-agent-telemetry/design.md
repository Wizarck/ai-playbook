...
3. **Reuse the existing project Langfuse instance** (Arturo's personal
   stack at consumer-d, or any consumer's existing Langfuse Cloud
   project).
...
- Existing consumer-d dashboard widgets (`dashboard.consumer-bfood.com`) work
...
incident** in the consumer-e or consumer-c-legacy retros. None are
...
consumer-e will bump submodule to v0.10.0 as part of Wave 3 kickoff;
consumer-c-legacy + consumer-d + consumer-b adopt opportunistically.
