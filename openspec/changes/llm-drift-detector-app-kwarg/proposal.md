...
> **Authored**: 2026-05-13.
> **Parent project**: `Wizarck/eligia-core` `openspec/changes/add-litellm-enforcement/` — this playbook PR satisfies the playbook-side of T7 (drift detector) of the cost-by-tag-dashboard Phase 1, specifically T7.5 (application= kwarg check) and T7.8 (CI warn-only step).
...
- Parent project: [Wizarck/eligia-core PR](https://github.com/Wizarck/eligia-core) — cost-by-tag-dashboard project, Phase 1, T7 of `add-litellm-enforcement`.
- Capability spec (eligia-core): `openspec/changes/add-litellm-enforcement/specs/llm-application-tag/spec.md` §"Drift detector enforcement".
